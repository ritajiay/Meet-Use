            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    @foreach ($edit_index as $data)
                        <form action="{{ route('teamrecord.store', ['id' => $data->id]) }}" method="post"
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="client_new" id="client_new" class="form-control" required>
                                        @foreach ($edit_index2 as $data5)
                                            <option id="client_text" value="{{ $data5->pID }}" selected>
                                                {{ $data5->cName }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="serial_new" id="client_new" class="form-control" required>
                                        @foreach ($lists3 as $data6)
                                            <option id="serial_text" value="{{ $data6->serial }}" selected>
                                                {{ $data6->ssNumber }} / {{ $data6->ssName }}</option>
                                        @endforeach
                                        @foreach ($test2 as $data_pro2)
                                            <option value="{{ $data_pro2->serial }}">{{ $data_pro2->projectname }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="penetration_new" id="projectlistpersonal_new" class="form-control"
                                        ...
                                        @foreach ($test as $data_pro)
                                            <option value="{{ $data_pro->categoryname }}">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    @foreach ($edit_index as $data)
                                        <input class="form-control-static" type="date" style="color: grey"
                                            value="{{ $data->time }}" id="time_new" name="time_new">
                                        <-請選擇日期 </div>
                                    @endforeach
                                </div>
                                <div class="row form-group">
                                ...
                                <option value="{{ $data2->time }}">{{ $data2->time }}</option>
                                @endforeach --}}
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <div class="col col-md-9">
                                            @foreach ($edit_index as $data3)
                                                <input class="form-control-static" value="{{ $data3->totaltime }}"
                                                    ...
                                                    style="color:gray;width:65px;" required>時
                                            @endforeach
                                            {{-- @foreach ($list2 as $data2)
                                        ...
                                        <div class="col col-md-9">
                                            @foreach ($time_change_new as $data_time_change_new)
                                                <input class="form-control-static"
                                                    ...
                                                    style="color:gray;width:65px" required>天
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
